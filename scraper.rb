...
class MarseillesCouncilPage < Scraped::HTML
  field :councillors do
    noko.xpath('.//table[4]/tr[td]').map do |tr|
...
wikipedia_url = 'https://fr.wikipedia.org/wiki/Liste_des_conseillers_municipaux_de_Marseille'

page = scrape(wikipedia_url => MarseillesCouncilPage)
